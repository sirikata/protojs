...
bool parseProto (const char *filename, const char *outputFilename, const char *outputInternalNamespace, \
    const char *outputExternalNamespace, char **package, pANTLR3_HASH_TABLE typeTable, \
    bool cleanUp, ProtoJSParser_protocol_return *retval, pProtoJSLexer *ret_lxr, pProtoJSParser *ret_psr, \
    pANTLR3_COMMON_TOKEN_STREAM*ret_tstream, pANTLR3_INPUT_STREAM* ret_stream)
{
...
bool generateASTProto (const char *filename, const char *outputFilename, const char *outputInternalNamespace, \
    const char *outputExternalNamespace, char *package, pANTLR3_HASH_TABLE typeTable, ProtoJSParser_protocol_return *retval, \
    pProtoJSLexer *ret_lxr, pProtoJSParser *ret_psr,pANTLR3_COMMON_TOKEN_STREAM *ret_tstream, pANTLR3_INPUT_STREAM *ret_stream)
{
